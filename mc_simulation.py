#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Nuclear Power / Persistence Floor
=================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Nuclear Power (Persistence Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "nuclear",
    "domain_name": "Nuclear Power",
    "theorem": "Persistence Floor",
    "classification": "Class 3 \u2014 Troublesome",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 44.0,
    "channels": {
        "C1_environmental_damage": {
            ...
            "high": 15.3,
            "weight": 0.35,
            "description": "$21.6B/yr; Chernobyl+Fukushima+Hanford $1.29T annualized"
        },
        "C2_health_externality": {
            ...
            "high": 9.6,
            "weight": 0.25,
            "description": "$12B/yr; 1 of 28 nations built repository (Onkalo, Finland)"
        },
        "C3_climate_cost": {
            "dist": "normal",
            "low": 3.8,
            ...
            "high": 5.6,
            "weight": 0.2,
            "description": "$20B/yr; 440 reactors, 9 weapon states, IAEA $180M budget"
        },
        "C4_ecosystem_degradation": {
            ...
            "high": 3.8,
            "weight": 0.1,
            "description": "$15B/yr; systematic cost overruns, 5% of payoff, 34% of cost"
        },
        "C5_governance_capture": {
            ...
            "high": 2.0,
            "weight": 0.1,
            "description": "$3B/yr; Price-Anderson caps at $16.3B vs $200B+ Fukushima"
        }
    },
    "impossibility_floor": 0.3
}
